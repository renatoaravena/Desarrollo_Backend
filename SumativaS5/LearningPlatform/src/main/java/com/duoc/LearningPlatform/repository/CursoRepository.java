...
public class CursoRepository {
    ...
    public CursoRepository() {
        listaCursos.add(new Curso(1L, "Spring Boot Basico", "Introduccion a microservicios", 10,true));
        listaCursos.add(new Curso(2L, "Docker para Desarrolladores", "Gestion de contenedores", 20,true));
        listaCursos.add(new Curso(3L, "Arquitectura de Software", "Patrones y diseño", 30,false)); // Inactivo
        listaCursos.add(new Curso(4L, "Bases de Datos con JPA", "Persistencia de datos", 40,true));
    }
